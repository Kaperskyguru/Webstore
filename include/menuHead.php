			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li style="padding-left: 20px;">New Customer? <button data-target = "#registerModal" data-toggle = "modal" class="btn btn-primary btn-xs" style="width: 60px; background-color: #48d1cc;">Sign Up</button></li>
					</ul>
				</li>
				</ul>
			</div>
