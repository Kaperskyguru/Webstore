...
<div id = "l">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href = "#order" data-toggle = "collapse" data-parent = "#sidebar-wrapper"><span class = "glyphicon glyphicon-shopping-cart"></span> Orders <i class = "caret"></i></a>
                ...
                <div class = "collapse" id = "order">
                    <ul class = "list-group ">
                        <li class = "list-group-item"><a href = "order.php?t=Active"><span class = "glyphicon glyphicon-plus"> </span> Active </a></li>
                        <li class = "list-group-item"><a href = "order.php?t=Pending"><span class = "glyphicon glyphicon-list"></span> Pending </a></li>
                        <li class = "list-group-item"><a href = "order.php?t=onship"><span class = "glyphicon glyphicon-remove-sign"> </span> On Ship</a></li>
                    </ul>
                </div>
            </li>
    ...
    <div id = "sidebar-wrapper-icon">
        <ul class = "sidebar-nav">
            ...
            <li><a href = "customers.php" data-toggle = "tooltip" title = "Account"><i class = "glyphicon glyphicon-user"></i></a></li>
            <li><a href = "addProduct.php" data-toggle = "tooltip" title = "Products"><i class = "glyphicon glyphicon-plus"></i></a></li>
            <li><a href = "order.php?t=Active" data-toggle = "tooltip" title = "Orders"><i class = "glyphicon glyphicon-shopping-cart"></i></a></li>
